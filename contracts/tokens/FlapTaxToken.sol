...
contract FlapTaxToken is OpenFourToken, IFlapTaxToken {
    ...
    uint16 public override buyFeeRate;
    uint16 public override sellFeeRate;

    // ─── Allocation ratios (base 1000) ───
    uint16 public override rateStocks;
    uint16 public override rateFundsWallet;
    uint16 public override rateBurn;
    uint16 public override rateDividend;
    uint16 public override rateLiquidity;
    uint16 public override rateUnallocated;

    // ─── Anti-Farmer ───
    /// @notice Timestamp after which V3 LP provisioning is allowed
    uint256 public override antiFarmerEndTime;
    ...
    uint256 public override feeToStocks;
    uint256 public override feeToFundsWallet;
    uint256 public override feeToBurn;
    uint256 public override feeToDividend;
    uint256 public override feeToLiquidity;
    uint256 public override totalTaxCollected;
    uint256 public feeDispatched;

    // ─── Addresses ───
    address public override fundsWallet;
    address public override stocksVault;
    ...
    uint256 public override feePerShare;
    ...
    // ─── Initializer ───
    function initialize(FlapTaxConfig calldata config) external override {
        require(_getInitializedVersion() == 0, "FT: already init");
    ...
    function onBondingTrade(address trader, uint256 quoteAmount, uint256 tokenAmount, bool isBuy)
        external override onlyTaxVault
    {
    ...
    function dispatchFees() external override {
        ...
        if (stocksAmt > 0 && stocksVault != address(0)) {
            ...
            if (Address.isContract(stocksVault)) {
    ...
    function collectStocksFee() external override {
